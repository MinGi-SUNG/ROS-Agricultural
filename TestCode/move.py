...
left_sonar = rospy.Subscriber('/sonar_dist_left',Float32, callback)
right_sonar = rospy.Subscriber('/sonar_dist_right', Float32, callback)
...
if __name__ == '__main__':
    ...
    for x, y, z, w in zip(goal_positions_x, goal_positions_y, goal_pose_z, goal_pose_w):
        # 만약 왼쪽 초음파 센서에서 7cm 이하 라면 오른쪽 좌표 선택
        # 만약 오른쪽 초음파 센서에서 7cm 이하 라면 왼쪽 좌표 선택
        # 둘 모두 아니 라면 중앙 좌표로 진행.
