...
while not rospy.is_shutdown():
    if left_sonar is not None:
        print("left_sonar_dist :", left_sonar)
        print(type(left_sonar))
    if right_sonar is not None:
        print("right_sonar_dist :", right_sonar)
    rate.sleep()
...
#                         0.34420867777245007, 0.9428930232051557, 0.9360162491430987, 0.9676714284011307,
#                         1.0012134875460368, 1.0414035190834385, 1.0414035190834385, 1.4932274084450738,
...
#                    0.6862762668634798, -0.7005033842350507, -0.7281633426560493, -0.6545859617152052,
#                    -0.6571213109779029, -0.6578621844792023, -0.6578621844792023, 0.6541658939362884,
...
#                    0.7273409692433982, 0.7136490795028331, 0.6854036375829712, 0.7559875784200293,
